...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $customers = [
            [
                'firstName' => 'John', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'john.smith@example.com',
            ...
            [
                'firstName' => 'Jane', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'jane.smith@example.com',
            ...
            [
                'firstName' => 'Robert', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'robert.smith@example.com',
            ...
            [
                'firstName' => 'Maria', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'maria.smith@example.com',
            ...
            [
                'firstName' => 'William', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'will.smith@example.com',
            ...
            [
                'firstName' => 'Sarah', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'sarah.smith@example.com',
            ...
            [
                'firstName' => 'Michael', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'mike.smith@example.com',
            ...
            [
                'firstName' => 'Lisa', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'lisa.smith@example.com',
            ...
            [
                'firstName' => 'David', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'david.smith@example.com',
            ...
            [
                'firstName' => 'Emily', 'lastName' => 'Smith', 'user_admin_id' => 1, 'email' => 'emily.smith@example.com',
