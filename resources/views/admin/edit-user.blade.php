                    ...
                    <form action="{{ route('admin.edit-user', $user->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" value="{{ $user->name }}" name="name" class="form-control bg-transparent text-white border-0" style="background-color: #1A1F37 !important;">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-white-50">Email</label>
                                <input type="email" value="{{ $user->email }}" name="email" class="form-control bg-transparent text-white border-0" style="background-color: #1A1F37 !important;">
                            </div>
                            <div class="col-md-6 mb-3">
